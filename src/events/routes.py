...
async def getEventById(event_uid: str, session: AsyncSession = Depends(get_session)) -> dict:
...
async def updateEventById(event_uid: str, event_data: EventUpdateModel, session: AsyncSession = Depends(get_session)) -> dict:
...
async def deleteEventById(event_uid: str, session:AsyncSession = Depends(get_session)):
